          ...
          <div className="col-span-12 mt-8">
            ...
            <div className="grid grid-cols-12 gap-6 mt-5">
              <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                <div>
                  <div className="px-4 py-7 box">
                    <div className="flex">
                      <p className="text-xl text-darkText	">New Enrollment</p>
                      <div className="ml-auto">
                        <Tippy
                          as="div"
                          className="cursor-pointer bg-danger py-[3px] flex rounded-full text-white px-[10px] items-center font-medium	text-base "
                    ...
                    <div className="mt-6 text-3xl font-medium leading-8 text-center">
                      185
                    </div>
                  </div>
                </div>
              ...
              <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                <div>
                  <div className="px-4 py-7 box border-danger">
                    <div className="flex">
                      <p className="text-xl	text-darkText">Critical Patient</p>
                      <div className="ml-auto">
                        <Tippy
                          as="div"
                          className="cursor-pointer bg-success py-[3px] flex rounded-full text-white px-[10px] items-center font-medium	text-base "
                    ...
                    <div className="mt-6 text-3xl font-medium leading-8 text-center text-danger">
                      15
                    </div>
                  </div>
                </div>
              ...
              <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                <div>
                  <div className="px-4 py-7 box border-warning">
                    <div className="flex">
                      <p className="text-xl	text-darkText">At-Risk Patient</p>
                      <div className="ml-auto">
                        <Tippy
                          as="div"
                          className="cursor-pointer bg-danger py-[3px] flex rounded-full text-white px-[10px] items-center font-medium	text-base "
                    ...
                    <div className="mt-6 text-3xl font-medium leading-8 text-center text-warning">
                      20
                    </div>
                  </div>
                </div>
              ...
              <div className="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                <div>
                  <div className="px-4 py-7 box border-success">
                    <div className="flex">
                      <p className="text-xl	text-darkText">Normal Patient</p>
                      <div className="ml-auto">
                        <Tippy
                          as="div"
                          className="cursor-pointer bg-success py-[3px] flex rounded-full text-white px-[10px] items-center font-medium	text-base "
                    ...
                    <div className="mt-6 text-3xl font-medium leading-8 text-center text-success">
                      150
                    </div>
                  </div>
                </div>
